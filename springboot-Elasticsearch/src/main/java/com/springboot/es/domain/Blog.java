package com.springboot.es.domain;
...
public class Blog implements Serializable {
	...
	public String toString() {
		return String.format("User[id=%s, title='%s', content='%s']", id, title, content);
		// return String.format("User[id=%d, title='%s', content='%s']", id, title, content);
	}
}
